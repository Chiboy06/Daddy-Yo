...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-900 text-gray-200">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-black to-gray-900 pt-20 pb-16">
        {/* Animated background elements */}
        <div className="absolute inset-0 z-0">
          <div className="absolute top-20 left-10 h-32 w-32 rounded-full bg-blue-700 opacity-20 blur-2xl"></div>
          <div className="absolute top-40 right-20 h-40 w-40 rounded-full bg-purple-700 opacity-20 blur-3xl"></div>
          <div className="absolute bottom-20 left-1/3 h-60 w-60 rounded-full bg-teal-700 opacity-10 blur-3xl"></div>
        </div>
        
        <div className="container relative z-10 mx-auto px-6">
          <div className="flex flex-col items-center justify-center space-y-12 text-center">
            <div className="animate-float rounded-full bg-gradient-to-r from-purple-700 to-blue-700 p-1">
              <div className="rounded-full bg-black bg-opacity-30 p-3 flex">
                {/* <AgentPulse size="medium" color="green"/> */}
                <Brain className="h-8 w-8 text-white" />
              </div>
            </div>
            
            <div className="space-y-4">
              <h1 className="bg-gradient-to-r from-blue-400 via-purple-400 to-teal-400 bg-clip-text text-5xl font-extrabold text-transparent sm:text-6xl md:text-7xl">
                Daddy Yo
                <span className="block text-2xl font-bold text-gray-300 sm:text-3xl">
            ...
            {/* <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-6">
              <button className="rounded-full bg-gradient-to-r from-purple-600 to-blue-600 px-8 py-3 font-medium text-white shadow-lg transition-all hover:from-purple-700 hover:to-blue-700 hover:shadow-xl">
                Get Started Now
              </button>
              <button className="rounded-full border border-gray-600 bg-gray-800 bg-opacity-50 px-8 py-3 font-medium text-gray-300 backdrop-blur-sm transition-all hover:bg-gray-700 hover:text-white">
                Watch Demo
              </button>
            </div> */}
            
            <div className="mt-10 w-full max-w-4xl rounded-2xl border border-gray-800 bg-gray-800 bg-opacity-30 p-6 backdrop-blur-sm">
        ...
        <div className="absolute bottom-0 left-0 w-full">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 120" fill="none">
            <path fillRule="evenodd" clipRule="evenodd" d="M0 0L60 10C120 20 240 40 360 50C480 60 600 60 720 50C840 40 960 20 1080 15C1200 10 1320 20 1380 25L1440 30V120H1380C1320 120 1200 120 1080 120C960 120 840 120 720 120C600 120 480 120 360 120C240 120 120 120 60 120H0V0Z" fill="#111827"/>
          </svg>
        </div>
      </section>
      ...
      <section className="bg-gray-900 py-24">
        <div className="container mx-auto px-6">
          <div className="mb-16 text-center">
            <h2 className="mb-4 text-4xl font-bold text-white">Power Features for Content Creators</h2>
          </div>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, index) => {
              const Icon = feature.icon
              return(
                <div key={index} className="group rounded-2xl border border-gray-800 bg-gray-800 bg-opacity-50 p-6 backdrop-blur-sm transition-all hover:border-gray-700 hover:bg-gray-800">
    ...
    <section className="bg-gray-900 py-24">
      <div className="container mx-auto px-6">
        ...
        <div className="relative mx-auto max-w-4xl">
          {/* Connecting line */}
          <div className="absolute left-1/2 top-0 h-full w-1 -translate-x-1/2 bg-gray-800"></div>
          ...
          <div className="relative z-10 space-y-24">
            {steps.map((step, index) => (
              <div key={index} className={`flex flex-col items-center ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                ...
                <div className={`mt-8 flex-1 rounded-2xl border border-gray-800 bg-gray-800 bg-opacity-50 p-8 backdrop-blur-sm md:mt-0 ${index % 2 === 0 ? 'md:ml-8' : 'md:mr-8'}`}>
                ...
                {index < steps.length - 1 && (
                  <div className="absolute left-1/2 top-16 z-0 h-32 w-6 -translate-x-1/2">
                    <svg className="h-full w-full" viewBox="0 0 24 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12 0V128" stroke="#374151" strokeWidth="2" strokeDasharray="4 4"/>
                    </svg>
                  </div>
                )}
              </div>
     ...
     {/* Footer */}
      <section className="relative overflow-hidden bg-gradient-to-t from-black to-gray-900 py-20">
        ...
        <div className="absolute inset-0 z-0">
          <div className="absolute top-10 left-20 h-20 w-20 rounded-full bg-blue-700 opacity-10 blur-2xl"></div>
          <div className="absolute top-40 right-10 h-32 w-32 rounded-full bg-purple-700 opacity-10 blur-3xl"></div>
          <div className="absolute bottom-20 left-1/4 h-40 w-40 rounded-full bg-teal-700 opacity-10 blur-3xl"></div>
          <div className="absolute bottom-40 right-1/4 h-32 w-32 rounded-full bg-pink-700 opacity-10 blur-3xl"></div>
        </div>
        ...
        <div className="container relative z-10 mx-auto px-6">
          <div className="flex flex-col items-center">
            <div className="mb-12 max-w-3xl text-center">
              <span className="mb-2 inline-block font-mono text-sm tracking-wider text-purple-400">ELEVATE YOUR CONTENT</span>
            ...
            {/* <div className="mb-12 flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-6">
              <button className="group relative overflow-hidden rounded-full bg-gradient-to-r from-purple-600 to-blue-600 px-8 py-3 font-medium text-white">
                <span className="relative z-10">Get Started Now</span>
                <div className="absolute inset-0 -z-0 translate-y-full bg-gradient-to-r from-blue-600 to-purple-600 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100"></div>
              </button>
              <button className="rounded-full border border-gray-600 bg-gray-800 bg-opacity-30 px-8 py-3 font-medium text-gray-300 backdrop-blur-sm transition-all hover:border-gray-500 hover:bg-gray-700 hover:text-white">
                Schedule a Demo
              </button>
            </div> */}
            ...
            <div className="flex w-full max-w-xl flex-col justify-center space-y-4 md:flex-row md:space-y-0 md:space-x-8">
              ...
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className="text-sm text-gray-400">Lightning-fast insights</span>
              </div>
            </div>
          </div>
        </div>
        
        <div className="container relative z-10 mx-auto mt-24 border-t border-gray-800 px-6 pt-8">
          <div className="flex flex-col justify-between space-y-8 md:flex-row md:space-y-0">
            <div>
              ...
              <div className="mt-6 flex space-x-4">
                <a href="#" className="rounded-full bg-gray-800 p-2 text-gray-400 hover:bg-gray-700 hover:text-white">
